import { Controller } from '@use-gesture/core/dist/declarations/src/Controller';
import { GestureKey, IngKey, State, Vector2 } from '@use-gesture/core/dist/declarations/src/types';
import { NonUndefined } from '@use-gesture/core/dist/declarations/src/types';
...
export declare abstract class Engine<Key extends GestureKey> {
     ...
     */
    get shared(): import("@use-gesture/core/dist/declarations/src/types").SharedGestureState;
    /**
     * Shortcut to the gesture event store read from the Controller.
     */
    get eventStore(): NonNullable<{
        drag?: import("@use-gesture/core/dist/declarations/src/EventStore").EventStore | undefined;
        wheel?: import("@use-gesture/core/dist/declarations/src/EventStore").EventStore | undefined;
        scroll?: import("@use-gesture/core/dist/declarations/src/EventStore").EventStore | undefined;
        move?: import("@use-gesture/core/dist/declarations/src/EventStore").EventStore | undefined;
        hover?: import("@use-gesture/core/dist/declarations/src/EventStore").EventStore | undefined;
        pinch?: import("@use-gesture/core/dist/declarations/src/EventStore").EventStore | undefined;
    }[Key]>;
    /**
     * Shortcut to the gesture timeout store read from the Controller.
     */
    get timeoutStore(): NonNullable<{
        drag?: import("@use-gesture/core/dist/declarations/src/TimeoutStore").TimeoutStore | undefined;
        wheel?: import("@use-gesture/core/dist/declarations/src/TimeoutStore").TimeoutStore | undefined;
        scroll?: import("@use-gesture/core/dist/declarations/src/TimeoutStore").TimeoutStore | undefined;
        move?: import("@use-gesture/core/dist/declarations/src/TimeoutStore").TimeoutStore | undefined;
        hover?: import("@use-gesture/core/dist/declarations/src/TimeoutStore").TimeoutStore | undefined;
        pinch?: import("@use-gesture/core/dist/declarations/src/TimeoutStore").TimeoutStore | undefined;
    }[Key]>;
    /**
     * Shortcut to the gesture config read from the Controller.
     */
    get config(): NonNullable<import("@use-gesture/core/dist/declarations/src/types").InternalConfig[Key]>;
    /**
     * Shortcut to the shared config read from the Controller.
     */
    get sharedConfig(): import("@use-gesture/core/dist/declarations/src/types").InternalGenericOptions;
    /**
     * Shortcut to the gesture handler read from the Controller.
     */
    get handler(): NonNullable<import("@use-gesture/core/dist/declarations/src/types").InternalHandlers[Key]>;
    reset(): void;
    /**
