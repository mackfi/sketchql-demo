...
import { TLDR } from '../../src/state/TLDR';
import { SessionArgsOfType, TldrawSession } from '../../src/state/sessions';
import { ArrowTool } from '../../src/state/tools/ArrowTool';
import type { BaseTool } from '../../src/state/tools/BaseTool';
...
export declare class TldrawApp extends StateManager<TDSnapshot> {
     ...
     * Set a setting.
     */
    setSetting: <T extends "language" | "isDarkMode" | "isCadSelectMode" | "isDebugMode" | "isPenMode" | "isReadonlyMode" | "isZoomSnap" | "keepStyleMenuOpen" | "nudgeDistanceSmall" | "nudgeDistanceLarge" | "isFocusMode" | "isSnapping" | "showRotateHandles" | "showBindingHandles" | "showCloneHandles" | "showGrid" | "dockPosition" | "exportBackground", V extends {
     ...
     */
    startSession: <T extends SessionType>(type: T, ...args: import("~types").ExceptFirst<ConstructorParameters<import("../../src/state/sessions").SessionOfType<T>>>) => this;
    /**
     * updateSession.
